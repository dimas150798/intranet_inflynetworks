...
class C_Stock_BarangAll extends CI_Controller
{
    ...
    public function GetDataAjax()
    {
        ...
        foreach ($result as $dataBarang) {
            ...
            //             <a onclick="EditNamaBarang(' . $dataBarang['id_stockBarang'] . ')"class="dropdown-item text-black"><i class="bi bi-pencil-square"></i> Edit</a>
            //             <a onclick="DeleteNamaBarang(' . $dataBarang['id_stockBarang'] . ')"class="dropdown-item text-black"><i class="bi bi-trash3-fill"></i> Hapus</a>
            //         </div>
            //     </div>';
            $data[] = $row;
        }
